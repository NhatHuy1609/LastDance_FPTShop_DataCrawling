...
class TelevisionIngestion(BaseIngestion):
    """Lớp nạp dữ liệu television từ FPT Shop."""
    
    def __init__(self, api_url: str, landing_zone_path: str, batch_size: int = 50):
        """
        Khởi tạo lớp nạp dữ liệu television.
        ...
        self.csv_filename = "fpt_tvs.csv"
        self.api_endpoint = "Television"
    ...
    def transform_data(self, df: pd.DataFrame) -> List[Dict[str, Any]]:
        """
        Chuyển đổi dữ liệu television từ DataFrame sang định dạng API.
        
        Args:
            df: DataFrame chứa dữ liệu television
        ...
        for _, row in df.iterrows():
            ...
            transformed_data.append(television)
    ...
    async def ingest_async(self) -> None:
        """Thực thi quá trình nạp dữ liệu television bất đồng bộ."""
        ...
        print(f"Đang gửi {total_records} bản ghi television đến API (bất đồng bộ)")
        ...
        print("Hoàn thành quá trình nạp dữ liệu television (bất đồng bộ)")
